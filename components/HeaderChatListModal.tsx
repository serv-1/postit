...
const HeaderChatListModal = () => {
  ...
  const [discussionsIds, setDiscussionsIds] = useState<string[]>([])
  ...
  useEffect(() => {
    ...
    const discussionDeletedHandler = (discussionId: string) => {
      setDiscussionsIds((ids) => ids.filter((id) => id !== discussionId))
    }
...
export default HeaderChatListModal
