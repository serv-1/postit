...
import { useForm, useFormContext, type RegisterOptions } from 'react-hook-form'
...
const formContext = {
  register: (name: string, options: RegisterOptions) => options,
...
vi.mock('react-hook-form', async (importOriginal) => ({
  ...
  useFormContext: vi.fn(() => formContext),
}))
