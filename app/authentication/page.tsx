    ...
    <main className="h-470 md:h-486 mb-auto md:shadow-wrapper md:flex">
      <div className="h-full flex flex-col rounded-2xl bg-fuchsia-50/60 backdrop-blur-xs shadow-glass p-32 md:backdrop-blur-none md:bg-fuchsia-50 md:shadow-none md:w-1/2 md:rounded-r-none md:items-center">
        ...
        <TabsProvider defaultValue="signIn">
          ...
          <TabPanel value="signIn" className="md:w-350">
            <SignInForm />
            <div className="flex flex-row flex-nowrap items-center gap-x-4 font-bold text-center rounded-full my-16 before:block before:h-1 before:w-1/2 before:bg-fuchsia-900 after:block after:h-1 after:w-1/2 after:bg-fuchsia-900">
              Or
            </div>
          ...
          <TabPanel value="register" className="md:w-350">
            <SignUpForm />
          </TabPanel>
        </TabsProvider>
      </div>
